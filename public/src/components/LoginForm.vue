<template>
  ...
  >
    <b-row>
      <i
        class="close-app ri-close-line"
        @click="closeApp()"
      />
      <b-col
        cols="4"
        class="text-center align-self-center bg-light"
      >
        <b-img
          :src="require('../img/logo-blx.png')"
          class="img-fluid"
        />
      </b-col>
      <b-col
      ...
      >
        <b-row class="pl-4">
          ...
          >
            ...
            <b-input-group
              class="input-group"
              :class="invalidField(exception.username)"
            >
              <b-form-input
                ref="usernameInput"
            ...
            <span
              v-if="exception.username"
              class="text-danger"
            >{{ exception.username }}</span>
          </b-col>
          <b-col
            cols="11"
            class="mb-4"
          >
            <label>Şifre</label>
            <b-input-group
              :class="invalidField(exception.password)"
            >
              <b-form-input
            ...
            <span
              v-if="exception.password"
              class="text-danger"
            >{{ exception.password }}</span>
          </b-col>
          <b-col
            cols="11"
            class="text-right"
